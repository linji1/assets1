    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        style.innerHTML += `
            .popup-little {
                ...
                border-radius: 8px; 修改 20241222*/
                padding: 10px;
                width: ${380-40}px;
                margin-left: 10px;
                margin-bottom: 0px;
                /* margin-top: 10px; 修改 20241222*/
                overflow: hidden;
                /* position: absolute */
                z-index: 9988;
            }
        ...
        if (position === 'up') {
            ...
            if (secondElement) {
                ...
                setTimeout(() => {
                    ...
                    // secondElement.style.marginTop = '10px';修改 20241222
            ...
            // height = rect.height;
            //popupLittle.style.marginBottom = `-${height}px`;修改20241222
            setTimeout(() => {
                //popupLittle.style.marginBottom = '10px';修改20241222
            }, 10);
