...
$(document).ready(function() {
    ...
    if (act == 'set' || act == 'wid') {
        ...
        editor.config.menus = ['source', 'bold', 'strikethrough', 'eraser', 'forecolor', 'quote', 'alignleft', 'aligncenter', 'alignright', 'link', 'unlink','img', 'video', 'table', 'insertcode', 'fullscreen', ];
